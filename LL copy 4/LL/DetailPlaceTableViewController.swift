...
class DetailPlaceTableViewController: UITableViewController {
    ...
    //https://api.foursquare.com/v2/venues/4e53f95345ddffa8d194673a?&client_id=GNKCCW0LNIPQTHLOXSH5Z0FAOGS4NE32JFUCAL2ZKPSMFCNN&client_secret=GO5RRJF5J2SFMQCCH5HQWW3D5YPLCW4GKVHR3EPVZKK3BVSC&v=20180202"
        if let finalURL2 = URL(string: baseURL2) {
        requestOnePlaceData(url: finalURL2)
        } else {
        print("malformed URL")
